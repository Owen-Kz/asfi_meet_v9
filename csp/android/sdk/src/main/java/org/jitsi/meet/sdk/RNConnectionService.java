...
/**
 * The react-native side of ASFI Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by ASFI Meet to
     *        a conference call.
     * @param handle - a call handle which by default is ASFI Meet room's URL.
