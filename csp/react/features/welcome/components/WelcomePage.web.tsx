...
class WelcomePage extends AbstractWelcomePage<IProps> {
    ...
    _onFormSubmit(event: React.FormEvent) {
        ...
        if (!this._roomInputRef || this._roomInputRef.reportValidity()) {
            ...
            fetch(`https://www.asfischolar.net/createMeetingFromRequest?rid=${room}`, {
                // method: 'POST',
                // headers: {
            ...
            .then(data => {
                ...
                // Once the data is successfully sent, continue with existing logic
                this._onJoin();
            })
            .catch(error => {
