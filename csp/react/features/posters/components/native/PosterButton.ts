...
import { POSTERS_ENABLED } from '../../../base/flags/constants';
...
function _mapStateToProps(state: IReduxState, ownProps: any) {
    const enabled = getFeatureFlag(state, POSTERS_ENABLED, true);
...
export default translate(connect(_mapStateToProps)(PostersButton));
