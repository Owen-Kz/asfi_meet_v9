...
import { IconMessage, IconPosters } from '../../../base/icons/svg';
...
/**
 * The type of the React {@code Component} props of {@link PostersButton}.
 */
 ...
 */
class PostersButton extends AbstractButton<IProps> {
...
export default translate(connect(mapStateToProps)(PostersButton));
