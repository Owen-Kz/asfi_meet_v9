 ...
 * JitsiMeetJS#init(). The app will download config.js from the ASFI Meet
 ...
 * The app will download config.js from the ASFI Meet deployment and take its
 ...
 * config.js from the ASFI Meet deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = merge(
        ...
        // downloaded from the ASFI Meet deployment because the former contains
