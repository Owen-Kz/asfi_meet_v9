...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'ASFI Meet';
    desktop.appScheme = desktop.appScheme || 'asfi-meet';
    ...
    ios.appName = ios.appName || 'ASFI Meet';
    ...
    android.appName = android.appName || 'ASFI Meet';
