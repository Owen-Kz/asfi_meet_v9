...
export default [
     ...
     * provided by, for example, ASFI Meet SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, ASFI Meet SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which ASFI Meet is to work with a CallKit call created outside of Jitsi
     * Meet and to be adopted by ASFI Meet such as, for example, an incoming
     * and/or outgoing CallKit call created by ASFI Meet SDK for iOS
     * clients/consumers prior to giving control to ASFI Meet. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, ASFI Meet SDK for iOS.
     *
