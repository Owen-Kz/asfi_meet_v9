...
/**
 * Signals that the configuration (commonly known in ASFI Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in ASFI Meet as config.js)
...
/**
 * Stores a specific ASFI Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The ASFI Meet config.js to store.
 * @returns {Function}
 */
