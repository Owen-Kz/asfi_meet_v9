...
/**
 * Restores a ASFI Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The ASFI Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "ASFI Meet"
    // }
    // We want to have:
    // json = {
    //     config: {
