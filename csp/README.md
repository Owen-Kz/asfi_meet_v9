# <p align="center">ASFI Meet</p>

ASFI Meet is a set of Open Source projects which empower users to use and deploy
...
Amongst others here are the main features ASFI Meet offers:
...
If you'd like to run your own ASFI Meet installation head over to the [handbook](https://jitsi.github.io/handbook/docs/devops-guide/) to get started.
...
All the ASFI Meet documentation is available in [the handbook](https://jitsi.github.io/handbook/).
...
If you are looking to contribute to ASFI Meet, first of all, thank you! Please
